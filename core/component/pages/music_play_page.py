...
class MusicPlayPage(QWidget):
    ...
    def __init__(self, db: NoteKeyBindingDBManager, parent: Optional[QWidget] = None):
        ...
        self.midi_tree = MidiCards(self, "C:/Users/25079/Documents/xwechat_files/wxid_1r0oybx892t422_fb53/msg/file/2025-10/泡泡弹奏（PC版）/9000多首MID/8000多首MID/诛仙世界自动演奏（含8000多首MID）/MID/midi_2/2.二次元")
        self.top_layout.addWidget(self.present_list_widget, 1) # 左侧占1份
        self.top_layout.addWidget(self.midi_tree, 1) # 右侧占1份
