...
class AppConfig(QConfig):
    ...
    player_play_shortcuts = ConfigItem("player","play_shortcuts",{"TriggerPlay": "space", "StartPlay": "right", "PlayNext": "down", "PlayPre": "up", "PausePlay": "left"},serializer=JsonSerializer())
    player_play_key_press_and_up = ConfigItem("player", "play_key_press_and_up", False, BoolValidator())
